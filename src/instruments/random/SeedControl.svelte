...
<div class="seed-control"><NumberField label="S" name="Reproducible seed" value={value.seed} min={0} max={4294967295} onchange={(v)=>value.seed=v}/><button type="button" onclick={renew}>New seed</button></div>
